...
for n=1:100000
    for i=1:20
        % iejimas i pasleptus sluoksnius
        v1_1 = w11_1*x(i)+b1_1;
        v2_1 = w21_1*x(i)+b2_1;
        v3_1 = w31_1*x(i)+b3_1;
        v4_1 = w41_1*x(i)+b4_1;
        v5_1 = w51_1*x(i)+b5_1;
        v6_1 = w61_1*x(i)+b6_1;
        % isejimas is pasleptu sluoksniu (sigmoidine funkcija)
        y1_1 = 1/(1+exp(-v1_1));
        y2_1 = 1/(1+exp(-v2_1));
        y3_1 = 1/(1+exp(-v3_1));
        y4_1 = 1/(1+exp(-v4_1));
        ...
        % pasleptu neuronu koeficientu svorio keitimas
        ...
        % pasleptu neuronu koeficientu poslinkis keitimas
